...
public class TestNG_ArchCertTestClass extends TestNG_BaseClass {
...
//		driver.get(loginPageURL);
		...
		WebElement txtUsername = ((RemoteWebDriver) driver).findElementById("username");
		txtUsername.sendKeys(strUsername);
		WebElement txtPassword = ((RemoteWebDriver) driver).findElementById("password");
		txtPassword.sendKeys(strPassword);
		WebElement btnLogin = ((RemoteWebDriver) driver).findElementById("Login");
		btnLogin.click();
		...
		WebElement linkLearnMore = ((RemoteWebDriver) driver).findElementByXPath(linkLearnMoreXpath);
		...
		WebElement linkResources = ((RemoteWebDriver) driver).findElementByXPath("//button/span[text()='Resources']");
		Actions action = new Actions(driver);
		action.moveToElement(linkResources);
		// Locate and click on certification
		WebElement linkCertfn = ((RemoteWebDriver) driver).findElementByXPath("//span[text()='Salesforce Certification ']/..");
		...
		((RemoteWebDriver) driver).findElementByXPath("//div[text()='Salesforce Architect']/..").click();
		...
		List<WebElement> allCertifications = ((RemoteWebDriver) driver)
				.findElementsByXPath("//div[text()='Certification']/following-sibling::div/a");
